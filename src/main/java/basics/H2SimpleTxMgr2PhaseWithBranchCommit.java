...
public class H2SimpleTxMgr2PhaseWithBranchCommit {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			pstmt.executeUpdate(); 
			xaRes.end(xid, XAResource.TMSUCCESS);//This example uses the two-phase commit protocol to commit one transaction branch
